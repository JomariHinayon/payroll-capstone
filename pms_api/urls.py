...
from .views import AccountRegistrationView, EmployeeLoginView, ObtainAuthTokenView, EmployeeViewSet, AttendanceViewSet, \
    PayrollViewSet, AdminLoginView, AnnouncementViewSet
